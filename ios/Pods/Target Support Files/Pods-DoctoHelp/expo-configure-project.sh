...
with_node \
  ...
  --target "/Users/neguelabegolli/DoctoHelp/ios/Pods/Target Support Files/Pods-DoctoHelp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-av" "expo-barcode-scanner" "expo-camera" "expo-constants" "expo-file-system" "expo-keep-awake" "expo-linear-gradient"
